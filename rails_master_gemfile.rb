...
group(:test) do
  gem 'rspec',              '2.0.0.b01'
  gem 'rspec-core',         '2.0.0.b01', :require => 'rspec/core'
  gem 'rspec-expectations', '2.0.0.b01', :require => 'rspec/expectations'
  gem 'rspec-mocks',        '2.0.0.b01', :require => 'rspec/mocks'
  gem 'rspec-rails',        '2.0.0.b01'
end
GEMFILE
end

...
Currently, {rspec-rails}[http:github.com/rspec/rspec-rails] isn't yet fully compatible with rails3 and not yet completely ORM agnostic. Preliminary support is available though.
